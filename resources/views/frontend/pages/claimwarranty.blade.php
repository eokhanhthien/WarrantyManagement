            ...
            <div class="container-fluid g-0">
                <div class="banner">
                    <div class="baner-content">
                        <h2 class='color-blue'>Yêu cầu bảo hành trực tuyến</h2>
                        <p>Để biết thêm thông tin, vui lòng truy cập trang đăng ký sản phẩm.</p>
                    </div>
                </div>

                <div class = "panel">
                <form action="{{route('send-claim-warranty')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class = "panel-title">Yêu cầu bảo hành</div>
                ...
                <div class="row mb-3">
                    <div class="col col-5 text-end"><button type='submit' class='btn btn-primary'>Gửi yêu cầu</button></div>
                </div>
                @if (session('message'))
                ...
                <div class="check-serial">
                    ...
                    <div class="row">
                        <div class="col col-12">
                            <img class='check-img' src="{{asset('frontend/images/policy.png')}}" alt="">
                        </div>
