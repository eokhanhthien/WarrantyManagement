...
<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Thêm Serial bảo hành</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Thêm Serial bảo hành</li>
                        </ol>
                    </div>
                ...
                <form action="{{route('add-serial')}}" method="post">
                @csrf
                <div class="wide">
                            @if($errors->any())
                    ...
                    <div class="col col-xl-8 ">
                        ...
                        <?php if(isset($manufacturer) && $manufacturer != NULL){ ?>
                            <?php foreach($manufacturer as $key => $val){?>
                                <option value="<?= $val['name'] ?>" data-city="<?= $val['id'] ?>"><?= $val['name'] ?></option>
                            <?php } ?>
                        <?php } ?>
                        </select>
                    </div>
                ...
                <div class="row g-0">
                        ...
                        <div class="col-8">
                            <input class="input-add-order" type="text" placeholder="Serial number" name="serial_number" >
                        </div>
                </div>
