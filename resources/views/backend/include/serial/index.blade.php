                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($serial as $key => $val)
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="{{route('serial-edit',$val['id'])}}" ><button class='btn-ct btn-primary'><img style ="width: 22px;" src="{{asset('frontend/images/edit.png')}}"></button></a>
                                                    <form method="POST" action="{{route('serial-delete',$val['id'])}}">  
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" onclick = "return confirm('Bạn có muốn xóa mục này không ?')" class='btn-ct btn-danger mt-2'><img style ="width: 22px;" src="{{asset('frontend/images/remove.png')}}"></button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
