...
<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Thêm dịch vụ</h3>
                        <ol class="breadcrumb">
                ...
                <form action="{{route('add-service')}}" method="post" class="form-border-5" enctype="multipart/form-data" id="service_form">
                @csrf
                <div class="wide">
                    <div class="row">
                        <div class="col-2"> <p class="label-add-order">Tên dịch vụ</p> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8"><input class="input-add-order" type="text" placeholder="Manufacturer content" id="content"  required>
                        <input type="hidden" name="content" id="service_content">
                        </div>
                    </div>
                </div>
                <div  onclick="submit()" class='btn btn-success mt-3'>Thêm</div>
                </form>
