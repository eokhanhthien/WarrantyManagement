...
<div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <button class="btn btn-success mr-10"> <a href="{{route('manufacturer-add')}}">Thêm hãng sản xuất</a> </button>
                <div class="row">
                    <!-- column -->
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $val['name'] }}</td>
                                                <td>
                                                    <a  href="{{route('manufacturer-edit',$val['id'])}}" ><button class='btn btn-primary'>Sửa</button></a>
