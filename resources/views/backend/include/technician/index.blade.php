...
<div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <button class="btn btn-success mr-10"> <a href="{{route('technicians-add')}}">Thêm nhân sự</a> </button>
                <div class="row">
                    <!-- column -->
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <table class="table mb-3" id='productTable'>
                                        ...
                                        @foreach($data as $key => $val)
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="{{route('technicians-edit',$val['id'])}}" ><button class='btn btn-primary'>Sửa</button></a>
