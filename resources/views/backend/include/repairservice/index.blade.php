...
<div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <button class="btn btn-success mr-10"> <a href="{{route('repair-service-add')}}">Thêm dịch vụ sửa chữa <img style ="width: 30px;" src="{{asset('frontend/images/plus.png')}}"></a> </button>
                <div class="row">
                    <!-- column -->
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <table class="table mb-3" id='productTable'>
                                        ...
                                        @foreach($data as $key => $val)
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="{{route('repair-service-edit',$val['id'])}}" ><button class='btn btn-primary'><img style ="width: 22px;" src="{{asset('frontend/images/edit.png')}}"></button></a>
